    ...
    <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        <Card>
          ...
          {[
            { label: 'Email notification for new assignments', defaultChecked: true },
            { label: 'Email notification when grades are posted', defaultChecked: true },
            { label: 'Push notifications for messages', defaultChecked: true },
            { label: 'Weekly academic digest email', defaultChecked: false },
          ].map((item, i) => (
        ...
        <Card>
          <h3 style={{ marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.75rem' }}><Globe size={20} color="var(--color-primary)" /> Display Preferences</h3>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: '500', marginBottom: '0.5rem' }}>Theme</label>
              <select style={{ width: '100%', padding: '0.75rem 1rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-border)', outline: 'none', background: 'white' }}>
        ...
        <Card>
          <h3 style={{ marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.75rem' }}><Lock size={20} color="var(--color-primary)" /> Change Password</h3>
